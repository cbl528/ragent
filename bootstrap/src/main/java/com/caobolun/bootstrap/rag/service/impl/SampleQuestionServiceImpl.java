...
import com.caobolun.bootstrap.rag.entity.SampleQuestionDO;
import com.caobolun.bootstrap.rag.mapper.SampleQuestionMapper;
...
public class SampleQuestionServiceImpl implements SampleQuestionService {
    ...
    public String create(SampleQuestionCreateRequest requestParam) {
        ...
        Assert.notBlank(question, () -> new ClientException("实例问题不能为空"));
